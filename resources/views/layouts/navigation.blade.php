        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Enlace a Pistas, visible solo para administradores -->
                    @if(Auth::user() && Auth::user()->isAdmin())
                    ...
                    @auth
                        ...
                        <!-- Enlace a Reserva (para clientes y administradores) -->
                    ...
                    <x-nav-link :href="route('contacto')" :active="request()->routeIs('contacto')">
                        ...
                        <x-nav-link :href="route('serSocio')" :active="request()->routeIs('serSocio')">
                            {{ __('Ser Socio') }}
                        </x-nav-link>
